...
""" Modified based on https://github.com/hughw19/NOCS_CVPR2019 and https://github.com/Gorilla-Lab-SCUT/DualPoseNet."""
...
if __name__ == "__main__":
    path1 = 'log/model_lite_results'
    path2 = 'log/model_results'

    print('Eval on {} ...'.format(path2))
    evaluate(path2)

    print('Eval on {} ...'.format(path1))
    evaluate(path1)
