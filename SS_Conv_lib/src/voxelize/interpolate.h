...
void three_nn(int n, int m, at::Tensor unknown_tensor,
...
void three_interpolate_fp(int c, int m, int n, at::Tensor points_tensor,
...
void three_interpolate_bp(int c, int n, int m, at::Tensor grad_out_tensor,
